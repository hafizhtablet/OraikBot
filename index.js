...
/////////////////
const BotName = 'OraikBot'; 
const instagram = '@HafizhTabletgaming'; 
const telegram = 'Kagak Punya, Yang punya mantan gua :v'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'Syahputra Hafizh Tablet';
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@hafizhtabletgaming`)
})
